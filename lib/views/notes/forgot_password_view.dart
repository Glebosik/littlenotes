...
import 'package:littlenotes/utilities/dialogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(children: [
            const Text(
                'If you forgot your password, simply enter your email and we will send you a passowrd reset link.'),
            TextField(
